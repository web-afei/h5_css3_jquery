...
var ge1doot = ge1doot || {
	json: null,
	screen: null,
	pointer: null,/* 代码整理：网页设计之家 www.mysite.com */
	camera: null,
	loadJS: function (url, callback, data) {
		if (typeof url == "string") url = [url];
		var load = function (src) {
			var script = document.createElement("script");
				if (callback) {/* 代码整理：网页设计之家 www.mysite.com */
...
ge1doot.Screen = function (setup) {
	...
	this.height = 0;
	this.cursor = "default";
	this.setup = setup;/* 代码整理：网页设计之家 www.mysite.com */
...
ge1doot.Pointer = function (setup) {
	...
	this.Yr         = 0;
	this.startX     = 0;
	this.startY     = 0;/* 代码整理：网页设计之家 www.mysite.com */
	this.scale      = 0;
	this.wheelDelta = 0;
...
/* 代码整理：网页设计之家 www.mysite.com */
	...
	this.pointerMove = function(e) {
		...
		if (this.isDown) {/* 代码整理：网页设计之家 www.mysite.com */
		...
		if (Math.abs(this.X - sX) > 11 || Math.abs(this.Y - sY) > 11) {
			...
			if (this.isDown) {
				if (!this.isDraging) {
					...
					this.isDraging = true;
				} else {/* 代码整理：网页设计之家 www.mysite.com */
	...
	this.pointerCancel = function(e) {
		...
		this.isDown = false;
		this.bXi = this.Xi;
		this.bYi = this.Yi;/* 代码整理：网页设计之家 www.mysite.com */
		sX = 0;
		sY = 0;
	}
	...
	}, false);/* 代码整理：网页设计之家 www.mysite.com */
